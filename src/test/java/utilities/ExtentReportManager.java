...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		repName = browser+"Test-Report-" + timeStamp + ".html";// with time stamp we are generating name
		...
		extent.setSystemInfo("Application", "emiCalculator.net");
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			String imgPath = new BaseClass().captureScreen(result.getName()+"Success");
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String imgPath = new BaseClass().captureScreen(result.getName()+"Failure");
			test.addScreenCaptureFromPath(imgPath);
